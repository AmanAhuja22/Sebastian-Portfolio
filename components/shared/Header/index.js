...
const Header = () => {
	return (
		<header className="purple-gradient   flex items-center justify-between pt-12 p-4  text-white h-20 lg:pr-12">
			<div className="p-0 ">
				<Image className="absolute" width="500" height="500" src={Logo} />
			</div>

			<div className=" hidden  font-satoshi2 lg:flex items-center">
